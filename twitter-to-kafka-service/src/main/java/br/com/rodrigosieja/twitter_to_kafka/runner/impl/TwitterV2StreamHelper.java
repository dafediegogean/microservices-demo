...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterToKafkaServiceConfiguration twitterConfiguration,
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterConfiguration.getTwitterV2BaseUrl());
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterConfiguration.getTwitterV2RulesBaseUrl());
